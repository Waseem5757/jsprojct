    ...
    switch (direction) {
        case 'South':
            ...
            if (boundaryCheck(temp)) {
                ...
                console.log("Now queen's  position is " + queen.position.x, queen.position.y);
            } else {
        ...
        case 'NorthWest':
            ...
            break;
        default : console.log("Your direction is invaild ...so please enter valid direction");
    }
​
}
​
function boundaryCheck(rowNum) {
    if (rowNum == 0 || rowNum == 1 || rowNum == 2 || rowNum== 3 || rowNum == 4 ||rowNum == 5 || rowNum == 6 || rowNum == 7)
        return true;
    else
        return false;
}
...
function boundaryCheck2(rowNum, colNum) {
    if ((rowNum == 0 || rowNum == 1 || rowNum == 2 || rowNum == 3 || rowNum == 4 || rowNum == 5 || rowNum == 6 || rowNum == 7) &&
        colNum == 0 || colNum == 1 || colNum == 2 || colNum == 3 || colNum == 4 || colNum == 5 || colNum == 6 || colNum == 7)
        return true;
    else
        return false;
}